...
Sources should be refreshed before public claims, grant applications, or regulated workflows. Local partner data should be verified directly before publishing a directory. Reddit/forums and app reviews may be used only as anecdotal voice-of-user evidence and must be labeled as such.
