# Community Pilot Model

## Pilot Models Compared

| Model | Strength | Weakness | Verdict |
| --- | --- | --- | --- |
| Home/family pilot | direct utility | high support burden | good for 3-5 design partners |
| Podiatry/wound-care partner | urgent need and credibility | clinical boundary risk | pair with community host |
| Senior center | strong local fit | procurement/permission cycles | strong second pilot |
| Church/community center | trust and space | volunteer variability | recommended first host |
| Pharmacy/medical supply | supply relevance | commercial conflict | directory partner first |
| Hospital discharge | high need | liability/integration complexity | later |
| Food bank | high need | food/diet boundaries | good partner track |

## Recommended First Pilot

Palm Beach County church/community center + podiatry/wound-care advisor hybrid.

## 90-Day Targets

- 50 people engaged.
- 25 support requests handled.
- 25 care packs delivered.
- 10 vendors vetted.
- 10 volunteers screened/onboarded.
- 3 community partners.
- 10 emergency sheets created.
- 10 reminder workflows configured.
- 3 NAS/vault demos.
- One public impact report.

## Weekly Workflow

Monday: triage requests and inventory. Tuesday-Wednesday: vendor/resource verification. Thursday: pack fulfillment and reminder setup. Friday: follow-up and incident review. Monthly: impact report and partner review.
