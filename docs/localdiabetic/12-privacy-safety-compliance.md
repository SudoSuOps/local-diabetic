...
| --- | --- | --- |
| Medical advice scope creep | Critical | scripts, training, escalation language, no dosing/treatment guidance |
| Emergency request mishandled | Critical | prominent emergency disclaimer, immediate 911/clinician language |
| Wound-care protocol implied | Critical | organization only; clinician-directed care |
| Vendor harms user | Critical | vetting, insurance, background checks, complaint process |
| Volunteer home-entry issue | High | background checks, role limits, two-person policies when needed |
| PHI overcollection | High | data minimization and local vault default |
| NAS data loss | High | backup checklist and user responsibility clarity |
| Minor/vulnerable adult consent | High | guardian/caregiver policy and legal review |
| FTC/deceptive privacy claim | High | match practice to policy; no tracking/data sale |
| HIPAA/BAA confusion | High | legal review before provider integrations |
| FDA SaMD boundary crossed | High | no diagnosis/treatment recommendations; product claims review |

## AI Allowed / Disallowed

Allowed: organize documents locally, summarize user-provided non-urgent records for user review, generate appointment questions, create checklists, classify support requests, draft family updates with approval.

Disallowed: diagnose, prescribe, dose medication, interpret urgent symptoms, recommend wound treatment, replace clinician judgment, hide uncertainty, auto-share records, rank vendors based on paid placement without disclosure.

## No-Medical-Advice Language

LocalDiabetic provides organization, reminders, local resource coordination, and non-medical support. It does not provide medical advice, diagnosis, treatment, medication dosing, wound-care instructions, or emergency triage. For medical questions, contact a licensed medical professional. For emergencies, call emergency services.

## Consent Form Outline

- Who is requesting help.
- What support category is requested.
- What data is needed.
- Who may see it.
- How long it is retained.
- How consent can be revoked.
- Medical boundary acknowledgment.
...
- No data harvesting.
- Data minimization.
- User-owned local vault.
- Optional sharing.
- Vendor/volunteer boundaries.
